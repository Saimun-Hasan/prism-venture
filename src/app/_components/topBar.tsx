    ...
    return (
        <div
            className={`
                ...
                ${isHomePage ? 'fixed w-full' : 'fixed bottom-4 left-4 rounded-2xl p-4'}`
            }
            style={{ "--topbar-height": "35px" } as React.CSSProperties}
        >
            <div className="flex items-center justify-center gap-2 md:gap-6 lg:gap-5 w-full max-w-6xl">
                ...
                <Link href="tel:+880-02-8417591" className="flex gap-1.5 items-center hover:text-yellow-200 transition-colors w-full sm:w-auto justify-center sm:justify-start py-1 text-xs md:text-sm" prefetch={false}>
                    <PhoneCall size={16} strokeWidth={1.75} className="shrink-0 hidden sm:block" />
